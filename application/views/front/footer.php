<footer>
                                ...
                                <div class="recent-posts">
                                    ...
                                    <div class="recent-post">
                                        <div class="recent-post-thumb">
                                            <img src="<?php echo base_url('public/') ?>images/recent-post1.jpg" alt="">
                                        </div>
                                    ...
                                    <div class="recent-post">
                                        <div class="recent-post-thumb">
                                            <img src="<?php echo base_url('public/') ?>images/recent-post2.jpg" alt="">
                                        </div>
                                        <div class="recent-post-info">
        ...
        <script src="<?php echo base_url('public/') ?>js/vendor/jquery-1.11.0.min.js"></script>
        <script src="<?php echo base_url('public/') ?>js/vendor/jquery.gmap3.min.js"></script>
